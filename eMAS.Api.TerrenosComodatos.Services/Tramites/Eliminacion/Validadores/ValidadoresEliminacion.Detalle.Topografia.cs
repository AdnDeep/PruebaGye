...
namespace eMAS.Api.TerrenosComodatos.Services
{
    ...
    {
        public bool ValidarRespuestaServidorTramiteTopografiaAccionAEliminar(ref Tuple<short, string> entrada
            , ref ResultadoDTO<int> salida) 
        {
            var parametros = $"ValidadoresEliminacionTramite Service Layer";
            var props = new Dictionary<string, object>(){
                                { "Metodo", "ValidarRespuestaServidorTramiteTopografiaAccionAEliminar" },
                                { "Sitio", "COMODATO-API" },
