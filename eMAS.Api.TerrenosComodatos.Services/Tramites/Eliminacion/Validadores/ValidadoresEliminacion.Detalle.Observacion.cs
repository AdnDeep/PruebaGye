...
namespace eMAS.Api.TerrenosComodatos.Services
{
    ...
    {
        public bool ValidarRespuestaServidorTramiteObservacionAccionAEliminar(ref Tuple<short, string> entrada
            , ref ResultadoDTO<int> salida) 
        {
            var parametros = $"ValidadoresEliminacionTramite Service Layer";
            var props = new Dictionary<string, object>(){
                                { "Metodo", "ValidarRespuestaServidorTramiteObservacionAccionAEliminar" },
                                { "Sitio", "COMODATO-API" },
