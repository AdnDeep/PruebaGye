...
namespace eMAS.Api.TerrenosComodatos.Services
{
    ...
    {
        public bool ValidarDatosClienteTramiteOficioEditViewModel(ref OficioTramiteEditViewModel entrada
            , ref ResultadoDTO<int> salida)
        {
            var parametros = $"ValidadoresEscrituraTramite Service Layer";
            var props = new Dictionary<string, object>(){
                                { "Metodo", "ValidarDatosClienteTramiteOficioEditViewModel" },
                                { "Sitio", "COMODATO-API" },
        ...
        public bool ValidarRespuestaServidorTramiteOficioAccionAgregar(ref Tuple<short, string> entrada
            , ref ResultadoDTO<int> salida) 
        {
            var parametros = $"ValidadoresEscrituraTramite Service Layer";
            var props = new Dictionary<string, object>(){
                                { "Metodo", "ValidarRespuestaServidorTramiteOficioAccionAgregar" },
                                { "Sitio", "COMODATO-API" },
                                { "Parametros", parametros }
                        };
            bool puedeContinuar = false;
        ...
        public bool ValidarRespuestaServidorTramiteOficioAccionActualizar(ref Tuple<short, string> entrada
            , ref ResultadoDTO<int> salida)
        {
            var parametros = $"ValidadoresEscrituraTramite Service Layer";
            var props = new Dictionary<string, object>(){
                                { "Metodo", "ValidarRespuestaServidorTramiteOficioAccionActualizar" },
                                { "Sitio", "COMODATO-API" },
                                { "Parametros", parametros }
                        };
            bool puedeContinuar = false;
