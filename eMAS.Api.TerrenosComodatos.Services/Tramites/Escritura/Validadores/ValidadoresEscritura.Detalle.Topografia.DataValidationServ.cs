...
namespace eMAS.Api.TerrenosComodatos.Services
{
    ...
    {
        public bool ValidaRespuestLogicDataValidationEscrituraTramiteTopografiaServidor(int idtopografiatramite, ref Tuple<List<SmcValidaDataServidor>,string> entrada
