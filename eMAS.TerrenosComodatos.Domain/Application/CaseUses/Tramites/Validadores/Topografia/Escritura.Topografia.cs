...
namespace eMAS.TerrenosComodatos.Domain.Application
{
    ...
    {
        public bool DataClienteEscrituraTopografia(ref TopografiaTerrenoEditViewMoel entrada, ref ResultadoDTO<int> salida)
        {
            ...
            {
                salida.mensaje = "Indicar un Tipo de Topografía es Obligatorio.";
                salida.tipo = "ADVERTENCIA";
                return puedeContinuar;
            }
