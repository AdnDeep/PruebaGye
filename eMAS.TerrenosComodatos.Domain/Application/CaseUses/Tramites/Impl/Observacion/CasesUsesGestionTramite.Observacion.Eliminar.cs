...
namespace eMAS.TerrenosComodatos.Domain.Application
{
    ...
    {
        private ResultadoDTO<int> EliminarObservacion(short id, string usuario, string controlador, string pcclient)
        {
            ...
            var respServRemoto = _repositorioExterno.EliminarObservacion(id, usuario, controlador, pcclient);
