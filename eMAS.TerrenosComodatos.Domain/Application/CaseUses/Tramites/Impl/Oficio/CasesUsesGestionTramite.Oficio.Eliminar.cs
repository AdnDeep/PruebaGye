...
namespace eMAS.TerrenosComodatos.Domain.Application
{
    ...
    {
        private ResultadoDTO<int> EliminarOficio(short id, string usuario, string controlador, string pcclient)
        {
            ...
            var respServRemoto = _repositorioExterno.EliminarOficio(id, usuario, controlador, pcclient);
